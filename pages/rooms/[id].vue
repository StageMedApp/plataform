                  ...
                  <li class="py-3 pb-2" v-for="u in users" :key="u.socket_id">
                    <div class="flex items-center space-x-4">
                      ...
                      <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-gray-900 truncate">{{ u.user.name }}</p>
                      </div>
                    </div>
                  </li>
                </ul>
      ...
      <Dialog as="div" class="relative z-10">
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
          <div class="flex min-h-full min-w-full items-center justify-center p-6 sm:p-0">
            ...
            >
              <DialogPanel
                class="relative transform overflow-hidden rounded-lg bg-card text-left shadow-xl transition-all w-full sm:max-w-3xl max-h-[95vh] md:max-h-[80vh] flex flex-col overflow-y-auto"
              >
