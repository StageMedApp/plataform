          ...
          >
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-card text-left shadow-xl transition-all w-full sm:max-w-lg">
              <Form @submit="save" :validation-schema="schema" :initial-values="ratingValue">
                  ...
                  <div class="grid">
                    <div class="flex justify-center">
                      <div class="d-rating d-rating-lg d-rating-half -ml-[3.75px]">
                        <Field type="radio" name="rate" :value="1" class="bg-secondary-yellow-500 d-mask d-mask-star-2" />
                        <Field type="radio" name="rate" :value="2" class="bg-secondary-yellow-500 d-mask d-mask-star-2" />
                        <Field type="radio" name="rate" :value="3" class="bg-secondary-yellow-500 d-mask d-mask-star-2" />
                        <Field type="radio" name="rate" :value="4" class="bg-secondary-yellow-500 d-mask d-mask-star-2" />
                        <Field type="radio" name="rate" :value="5" class="bg-secondary-yellow-500 d-mask d-mask-star-2" />
                      </div>
                    </div>
                    <div class="mt-4">
                ...
                <div class="flex-col items-center justify-center bg-gray-50 flex px-4 py-4 gap-2">
                  <Button size="small" color="primary" :loading="loading"> Enviar avaliação </Button>
                  <Button size="small" color="linkError" tag="div" @click="closeModal" ref="cancelButtonRef"> Cancelar </Button>
                </div>
              </Form>
            </DialogPanel>
          </TransitionChild>
